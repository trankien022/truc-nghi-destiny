          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="space-y-6">
              {painPoints.map((point, index) => (
                <div key={index} className="flex items-start gap-3 animate-slide-up" style={{animationDelay: `${index * 0.1}s`}}>
                  ...
                  <p className="text-foreground font-inter leading-relaxed">{point}</p>
                </div>
              ))}
            </div>
            ...
            <div className="bg-gradient-card rounded-2xl p-8 shadow-medium animate-scale-in">
              ...
              <p className="text-foreground font-inter leading-relaxed italic">
                "Mỗi sáng thức dậy với tâm thế tỉnh táo, biết xu hướng vận hạn để chọn đúng việc cần làm hôm nay. 
                Không còn lo lắng mù mờ, mà có định hướng rõ ràng cho từng giai đoạn cuộc đời."
              </p>
            </div>
          </div>
        </div>
